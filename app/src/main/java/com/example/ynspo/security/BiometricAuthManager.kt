...
class BiometricAuthManager @Inject constructor() {
    ...
    private fun startBiometricAuth(context: Context, onError: (String) -> Unit, onSuccess: () -> Unit, onFail: () -> Unit) {
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            ...
            .setSubtitle("Usa tu huella dactilar, reconocimiento facial o PIN/patrón")
            .setDescription("Para acceder a tus boards, debes autenticarte con tu método de desbloqueo preferido")
